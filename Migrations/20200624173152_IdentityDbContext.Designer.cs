...
namespace PetrasWebShop.Migrations
{
    ...
    [Migration("20200624173152_IdentityDbContext")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetrasWebShop.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("PetrasWebShop.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("PetrasWebShop.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("PetrasWebShop.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PetrasWebShop.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("PetrasWebShop.Models.OrderDetail", b =>
                {
                    b.HasOne("PetrasWebShop.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PetrasWebShop.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PetrasWebShop.Models.Pie", b =>
                {
                    b.HasOne("PetrasWebShop.Models.Category", "Category")
                        .WithMany("Pies")
